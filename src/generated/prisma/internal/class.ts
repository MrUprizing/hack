...
> {
  ...
  /**
   * `prisma.proyect`: Exposes CRUD operations for the **Proyect** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more Proyects
   * const proyects = await prisma.proyect.findMany()
   * ```
   */
  get proyect(): Prisma.ProyectDelegate<ExtArgs, { omit: OmitOpts }>;
}
